...
public class PortfolioServiceImpl implements PortfolioService {
	...
	public List<PortfolioTransaction> getTransactions(String email) {
		...
		return transactionRepository.findByEmailOrderByTransactionDateDesc(email);
	}
	...
	public PortfolioDashboardDto getDashboardSummary(String email){
		  PortfolioDashboardProjection projection =
                holdingRepository.getDashboardMetrics(email);

        PortfolioDashboardDto dto = new PortfolioDashboardDto();

        dto.setTotalHoldings(projection.getTotalHoldings());
        dto.setTotalInvested(projection.getTotalInvested());
        dto.setBuyTransactions(projection.getBuyTransactions());
        dto.setSellTransactions(projection.getSellTransactions());
        dto.setWeeklyInvestment(projection.getWeeklyInvestment());
        dto.setMonthlyInvestment(projection.getMonthlyInvestment());
        dto.setYearlyInvestment(projection.getYearlyInvestment());
        dto.setHighestInvestment(projection.getHighestInvestment());
        return dto;
	}
}